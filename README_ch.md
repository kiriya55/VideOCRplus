[English](https://github.com/kiriya55/VideOCRplus/blob/master/README.md) | 中文

<p align="center">
<img src="https://github.com/kiriya55/VideOCRplus/raw/master/Pictures/VideOCR.png" alt="VideOCRplus 图标" width="128">
...
| 开发者模式 | 无 | 直接通过 `python gui.py` / `python cli.py` 运行 |
...
![image](https://github.com/kiriya55/VideOCRplus/raw/master/Pictures/GUI.png)
...
### 示例用法：
```bash
python cli.py --video_path "视频路径/example.mp4" --output "字幕保存路径/example.srt" --lang en --time_start "18:40" --use_gpu true
```

### LLM Vision 示例用法：
```bash
python cli.py --video_path "视频路径/example.mp4" --output "字幕保存路径/example.srt" --ocr_engine llm_vision --llm_api_key YOUR_KEY --llm_api_base https://api.openai.com/v1 --llm_model gpt-4o
```
...
- `crop_x(2)`, `crop_y(2)`, `crop_width(2)`, `crop_height(2)`
  ...
  指定OCR区域的像素范围。示例见下图：
  ![image](https://github.com/kiriya55/VideOCRplus/raw/master/Pictures/crop_example.png)
